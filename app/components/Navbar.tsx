        ...
        <header className="bg-[#100e29]   w-full">
            <div className='container mx-auto md:px-0 px-8'>
                <div className='flex justify-between items-center  py-4'>
                    ...
                    <div className={` ${!value?"top-[10%] md:-top-[80%]":"-top-[80%] "}  md:static absolute bg-[#100e29] md:bg-transparent md:min-h-fit min-h-[60vh] left-0 w-full ease-in-out flex  justify-center items-center md:justify-end transition-all transform duration-300 -z-10 md:z-0`}>
