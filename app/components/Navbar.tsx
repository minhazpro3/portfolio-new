        ...
        <header className="bg-transparent w-full ">
            <div className='container mx-auto md:px-0 px-8'>
                <div className='flex justify-between items-center  py-4 '>
                    ...
                    <div className={` ${!value ? "top-[0%] md:-top-[80%] " : " -top-[100%] "}  md:static absolute bg-[#152b44] md:bg-transparent md:min-h-fit min-h-[80vh] left-0 w-full ease-in-out   flex  justify-center items-center md:justify-end transition-all transform duration-300 z-10 `}>
                        <div className='flex md:flex-row flex-col gap-y-5 py-8 md:py-0 md:gap-x-4 text-[#878a8fe7] '>

                            <a className='bg-indigo-950 md:bg-transparent  py-1 md:py-0 w-full px-20 md:px-1 hover:text-white font-semibold' href="https://minhazweb.vercel.app/"  >Home</a>

                            <a>
                                <Link
                                    className='bg-indigo-950 md:bg-transparent py-1 md:py-0 w-full px-20 md:px-1 cursor-pointer hover:text-white font-semibold '
                                    to="projects"
                                    spy={true}
                                    smooth={true}
                                    duration={500}
